...
Apply masks to the gradient in the "Masking" section:

- **Mask Texture**: Use the R channel of a texture as a mask
- **Vertex Color**: Use the R channel of vertex colors as a mask
- **Invert Mask**: Invert the mask application
